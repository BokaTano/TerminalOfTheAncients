...
class ASCIIArt {
    ...
    private static func getChamberArt(taskId: Int) -> String {
        ...
        case 5: // The Shell Script Ritual
            return """
            ...
            ║  ████████████████████████████████████████████████████████  ║
            ║                                                              ║
            ║  The ancient shell script executes flawlessly, its          ║
            ║  commands flowing like digital incantations. Terminal       ║
            ║  output streams across the walls in glowing green text.     ║
            ║                                                              ║
            ║  You have mastered the art of automation, proving           ║
            ║  your worthiness to the ancient developers.                 ║
            ║                                                              ║
            ║  The path to the final vault now lies before you...         ║
            ╚══════════════════════════════════════════════════════════════╝
            
            """
            
        case 6: // The Vault Gate
            return """
