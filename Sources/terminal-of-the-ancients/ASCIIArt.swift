...
class ASCIIArt {
    ...
    private static func getChamberArt(taskId: Int) -> String {
        ...
        case 2: // Glyph Matrix
            ...
            ║  its coordinates revealed: 53.179N 4.855E                    ║
            ║                                                              ║
            ║  The glyph matrix has been reconstructed,                    ║
            ║  and the ancient knowledge flows through you...              ║
            ║                                                              ║
